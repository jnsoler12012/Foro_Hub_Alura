...
import com.nicolas.forohub.dto.UsuarioDatos;
import com.nicolas.forohub.dto.UsuarioRegistrarDatos;
import com.nicolas.forohub.model.Usuario;
import com.nicolas.forohub.repository.UsuarioRepository;
import com.nicolas.forohub.utils.security.JwtData;
import com.nicolas.forohub.utils.security.TokenService;
...
public class UsuarioController {
    ...
    public ResponseEntity<?> register(@RequestBody @Valid UsuarioRegistrarDatos usuarioRegistrarDatos) {
        ...
        Usuario usuario = new Usuario(usuarioRegistrarDatos.getNombre(), usuarioRegistrarDatos.getEmail(),
                encryptedPassword);
