...
import com.alurachallenge.forohub.forohub.dto.TopicoDatos;
import com.alurachallenge.forohub.forohub.dto.TopicoRegistrarDatos;
import com.alurachallenge.forohub.forohub.model.Topico;
import com.alurachallenge.forohub.forohub.model.Usuario;
import com.alurachallenge.forohub.forohub.repository.TopicoRepository;
...
public class TopicoController {
    ...
    public ResponseEntity<?> actualizarTopico(@PathVariable("id") Long id, @RequestBody @Valid TopicoRegistrarDatos topicoRegisterData, Authentication authentication) {
        String nombre = authentication.getName();
